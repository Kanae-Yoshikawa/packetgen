...
#include "Ether.h"          // ヘッダーファイルとして用意．注）""だから同一ディレクトリ
#include <fcntl.h>
#include <stdio.h>
#include <sys/types.h>
...
#define VLAN        Yes     //YES って何？？　Ethe.hの#ifdefで呼び出してる
#define DEBUG       0
#define MAX_PACKET_SIZE 2048    // Sufficiently larger than the MTU
#define Period      1

enum commMode {SendAndReceive = 0, ReceiveThenSend = 1};    //列挙体　p.191参照
